...
public class GoogleLocationListener implements com.google.android.gms.location.LocationListener {
    ...
    public GoogleLocationListener(LocationManager manager, GeoBroker broker, String tag) {
    ...
    protected void fail(int code, String message) {
        ...
        if(this.owner.isLocationListener() && this.watches.size() == 0)
        {
    ...
    private class LocationTimeoutTask extends TimerTask {
    	...
    	private GoogleLocationListener listener = null;
    	
    	public LocationTimeoutTask(CallbackContext callbackContext, GoogleLocationListener listener) {
